 ...
 */
public class JavaServiceIntefaceGen extends AbstractJavaGen{

    public JavaServiceIntefaceGen(JavaGenConfig javaGenConfig, Map<String, Class> entityFields) {
    ...
    public void gen() throws IOException {
        ...
        methods.add(oneTab+"int count("+entityName+" " + aliasEntity+");");
        methods.add(oneTab+"List<"+entityName+"> list("+entityName+" " + aliasEntity+",int start, int limit);");
